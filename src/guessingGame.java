...
public class guessingGame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("TI-92p Mini Sans", 3, 24)); // NOI18N
        ...
        jLabel2.setText("Determine a secret number between 1 and 100.");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double numberOfEnter;
        numberOfEnter = Double.parseDouble(enter.getText());
        if (numberOfEnter == 54)
        {
            value.setText("you got it!!!!!");
            
        }
        else if (numberOfEnter > 54)
        {
            value.setText("too hight~~~");
        }
        else if (numberOfEnter < 54)
        {
            value.setText("too low....");
        }
